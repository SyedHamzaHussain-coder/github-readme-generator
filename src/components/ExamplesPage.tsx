...
- 📖 Wiki: [Internal Wiki](https://wiki.company.com/platform)`
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-primary to-slate-900 text-white">
      ...
      {/* Examples Grid */}
      <div className="relative z-10 px-2 sm:px-4 pb-10 sm:pb-16">
        <div className="max-w-7xl mx-auto">
            ...
            {examples.map((example, index) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6 border-b border-gray-700/30">
                  ...
                  <p className="text-gray-300 text-xs sm:text-sm mb-4 line-clamp-2">{example.description}</p>
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 h-32 sm:h-40 overflow-hidden border border-gray-300 relative">
          ...
          {/* Call to Action */}
          <div className="text-center mt-10 sm:mt-16 p-4 sm:p-8 bg-gradient-to-r from-primary/30 to-secondary/30 rounded-2xl border border-secondary/20">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-4">Ready to Create Your Own?</h3>
            ...
            <button 
              ...
              className="bg-gradient-to-r from-primary to-secondary hover:from-primary-dark hover:to-secondary-dark px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 inline-flex items-center text-sm sm:text-base"
            >
      ...
      {selectedExample && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg sm:max-w-2xl md:max-w-3xl lg:max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl">
            {/* Modal Header */}
            <div className="bg-gray-50 border-b border-gray-200 p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
            ...
            {/* Modal Footer */}
            <div className="bg-gray-50 border-t border-gray-200 p-3 sm:p-4 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-2 sm:gap-0">
              <div className="text-xs sm:text-sm text-gray-600">
                This is how your README will look on GitHub
              </div>
              <button 
                onClick={() => navigate('/connect')}
                className="bg-gradient-to-r from-primary to-secondary hover:from-primary-light hover:to-secondary-light px-4 sm:px-6 py-2 rounded-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 inline-flex items-center text-xs sm:text-base"
              >
